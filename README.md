...
<pre><code class="language-json">
  ...
  "profiles": {
    ...
    "https": {
      ...
      "dotnetRunMessages": true,
      "launchBrowser": false,
      "applicationUrl": "https://localhost:7123;http://localhost:5055",
      "environmentVariables": {
        "ASPNETCORE_ENVIRONMENT": "Development"
      }
    }
  ...
  "iisSettings": {
    ...
    "iisExpress": {
      "applicationUrl": "http://localhost:50781/",
      "sslPort": 44395
    }
  }
}
...
<p> "winBuild": "set \"GENERATE_SOURCEMAP=false\" && react-scripts build", </p>
...
<p> dotnet tool install --global dotnet-ef 	 </p>
<p> dotnet ef dbcontext scaffold "Host=localhost;Database=vaccinedb;Username=postgres;Password=1234qqq" Npgsql.EntityFrameworkCore.PostgreSQL --output-dir Data --context AppDbContext --no-onconfiguring --force --use-database-names  </p>
